...
namespace Amazon.Store
{
    ...
    public class EndpointConfig : IConfigureThisEndpoint
    {
        public void Customize(BusConfiguration configuration)
        {
            ...
            configuration.UsePersistence<NHibernatePersistence>().ConnectionString(@"server=.\sqlexpress;database=amazon;integrated security=sspi;application name=Amazon");
